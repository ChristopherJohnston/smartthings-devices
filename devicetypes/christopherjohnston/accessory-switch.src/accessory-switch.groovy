metadata {
    ...
    // https://community.smartthings.com/t/faq-solution-for-linear-gocontrol-3-way-switches-wd500z-1-and-wt00z-1-association-options/54362/27
    // https://gist.github.com/mckeed/182cc9689299e20af17b
	definition (name: "Accessory Switch", namespace: "christopherjohnston", author: "ChristopherJohnston") {
		capability "Switch"
...
def dimmerEvents(physicalgraph.zwave.Command cmd) {
	...
	if (cmd.value > 0 && cmd.value < 100) {
    	...
    	results << createEvent(name:"level", value: 99, unit: "%")
    }
	results
    log.debug("dimmer event: '$cmd.value'")
}
